...
import com.movieverse.movieverse.store.ejb.OrderDetailBean;
...
public class OrderDetailController {
    ...
    @EJB
    private com.movieverse.movieverse.store.ejb.OrderDetailBean ejbFacade;
    ...
    public static class OrderDetailControllerConverter implements Converter {
        ...
        com.movieverse.entities.OrderDetailPK getKey(String value) {
            com.movieverse.entities.OrderDetailPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.movieverse.entities.OrderDetailPK();
            key.setOrderId(Integer.parseInt(values[0]));
            key.setProductId(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.movieverse.entities.OrderDetailPK value) {
